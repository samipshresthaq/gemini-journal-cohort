...
export const AdminUsers: React.FC<AdminUsersProps> = ({
  ...
  return (
    <div className="space-y-6">
      {/* Secret Manager & Access Governance Status Banner */}
      <div
        id="banner-governance-status"
        className="p-4 rounded-2xl bg-gradient-to-r from-purple-500/10 via-indigo-500/10 to-transparent dark:from-purple-950/40 dark:via-indigo-950/30 border border-purple-200 dark:border-purple-800/80 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-2xs"
      >
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-sm font-bold text-slate-900 dark:text-white">
                Secret Manager & IAM Access Governance
              </h3>
              <span className="px-2 py-0.5 rounded-md bg-purple-100 dark:bg-purple-900/60 text-purple-800 dark:text-purple-300 text-[10px] font-extrabold uppercase">
                Zero-Hardcoding Active
              </span>
            </div>
            <p className="text-xs text-slate-600 dark:text-slate-300 mt-0.5">
              System credentials and API tokens are dynamically resolved via Google Cloud Secret Manager. Credentials are never rendered in client interfaces.
            </p>
          </div>
        </div>

        <div className="flex flex-wrap items-center gap-2 text-xs">
          <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-emerald-50 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800 text-[11px] font-semibold">
            <Check className="w-3 h-3 text-emerald-500" />
            Secret Manager Linked
          </span>
          <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-indigo-50 dark:bg-indigo-950/60 text-indigo-700 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-800 text-[11px] font-semibold">
